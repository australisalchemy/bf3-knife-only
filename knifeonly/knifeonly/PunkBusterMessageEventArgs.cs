...
{
    /// <summary>
    /// Provides data for the <see cref="RconClient.PunkBusterMessage"/> event.
    /// </summary>
    [Serializable]
    public class PunkBusterMessageEventArgs : EventArgs
    {
        /// <summary>
        ...
        /// <remarks>
        /// The <see cref="Message"/> may contain other characters, such as newlines (carriage returns and/or line feeds).
        /// </remarks>
        public string Message { get; private set; }

        internal PunkBusterMessageEventArgs(string message)
        {
            Message = message;
        }
    }
