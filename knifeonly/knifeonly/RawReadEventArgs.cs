...
{
    /// <summary>
    /// Provides data for the <see cref="RconClient.RawRead"/> event.
    /// </summary>
    [Serializable]
    public class RawReadEventArgs : EventArgs
    {
        /// <summary>
        /// Gets the <see cref="Packet"/> that was read from the server.
        /// </summary>
        /// <value>A <see cref="Packet"/> containing data read from the server.</value>
        public Packet Packet { get; private set; }

        internal RawReadEventArgs(Packet p)
        {
            Packet = p;
        }
    }
